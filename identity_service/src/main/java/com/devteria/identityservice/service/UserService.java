...
public class UserService {
    ...
    public void deleteUser(String userId) {
        ...
        // Xóa tất cả các appointment của user trước
        appointmentRepository.deleteByUserAppointmentId(userId);

        // Xóa hồ sơ bác sĩ trước khi xóa người dùng
        doctorProfileService.deleteByUserId(userId);
